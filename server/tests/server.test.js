...
// This func is gonna run before every test-case. Removes every todos, and then inserts some dummy data
        ...
        request(app)
            ...
            .end((err) => {
                ...
                User.findOne({email}).then((user) => {
                    ...
                    expect(user.password).not.toBe(password); // The hashed data should return
                    done();
                }).catch((e) => done(e));
            });
    });
